...
class TerminalChat:
    ...
    def get_command_confirmation(self, command: List[str], apply_patch: Optional[ApplyPatchCommand]) -> CommandConfirmation:
        """
        ...
        if function_name == "run_terminal_cmd":
            ...
            try:
                ...
                if not self.full_stdout and len(result.split("\n")) > 10:
                    lines = result.split("\n")
                    print("\n".join(lines[:10]))
                    print(colored_text(f"... and {len(lines) - 10} more lines (use --full-stdout to see all)", "bright_black"))
                else:
                    print(result)
    ...
    def print_header(self):
        ...
        print(f"{TermColor.BRIGHT_CYAN} {TermColor.BRIGHT_WHITE}Codex CLI v{CLI_VERSION}{TermColor.BRIGHT_CYAN}{TermColor.RESET}")
        print(f"{TermColor.BRIGHT_CYAN} {TermColor.BRIGHT_WHITE}Directory: {cwd}{TermColor.BRIGHT_CYAN}{TermColor.RESET}")
        print(f"{TermColor.BRIGHT_CYAN} {TermColor.BRIGHT_WHITE}Model: {self.config.model}{TermColor.BRIGHT_CYAN}{TermColor.RESET}")
        print(f"{TermColor.BRIGHT_CYAN} {TermColor.BRIGHT_WHITE}Approval Policy: {policy_color}{self.approval_policy}{TermColor.BRIGHT_CYAN}{TermColor.RESET}")
        print(f"{TermColor.BRIGHT_CYAN}────────────────────────────────────────────────{TermColor.RESET}")
        print(f"{TermColor.BRIGHT_BLACK}Type your message and press Enter. Use Ctrl+C to exit.{TermColor.RESET}")
        print()
    ...
    def run(self):
        ...
        print("\nThank you for using Codex CLI. Goodbye!") 